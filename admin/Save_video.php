...
$sql = "INSERT INTO video(name,artist,year,genre,description,filepath,trailer,ctg_id)              
VALUES ('$video_name','$artist_name','$year_name','$genre_name','$movie_desc','$file_name','$video_trailer','$video_Category')";
