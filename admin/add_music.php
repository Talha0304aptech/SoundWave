                                    ...
                                    <div class="tab-pane show active" id="basic-form-preview">
                                        ...
                                        <form action="Save_music.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class=" col-10">
                                                    <input type="text" name="music_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                </div>
                                                ...
                                                <div class=" col-10">
                                                    <input type="file" name="video_img" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""required>
                                                </div>
...
-->
                                                ...
                                                <div class="mt-2 col-10">
                                                    <select name="video_Category" class="form-select" id="example-select" required>
                                                        ...
                                                        $sql = "SELECT * FROM category"; // if there is anyname same username record be not be inserted
