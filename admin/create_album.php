                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-3">
                                    <div class="tab-pane show active" id="basic-form-preview">
                                        ...
                                        <form action="create_Save_album.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class=" col-10">
                                                    <input type="text" name="album_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                </div>
                                                ...
                                                <div class=" col-10">
                                                    <input type="file" name="album_img" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                </div>
