    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0 ms-md-auto">
        ...
        <main class="p-4 min-vh-100">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT *,category.category_name,category.category_id FROM video 
                JOIN category ON video.ctg_id = category.category_id                                   
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                ...
                                                <form action="Save_Update_video.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row">

                                                        <div class="form-group">
                                                            <input type="hidden" name="video_id" class="form-control" value="<?php echo $row['video_id'] ?>" placeholder="">
                                                        </div>
                                                        <div class="mt-1 mb-3 col-2">
                                                            <label for="exampleInputEmail1" class="form-label">video Name : </label>
                                                        </div>
                                                        <div class=" col-10">
                                                            <input type="text" name="video_name" value="<?php echo $row['name'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="file" name="new_video_img" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" >
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="text" name="video_trailer" value="<?php echo $row['trailer'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class="col-10">
                                                            <textarea name="video_desc" class="form-control" required rows="5">
                                                        ...
                                                        <div class="mt-2 col-10">
                                                            <select name="video_Category" class="form-select" id="example-select" required>
