        ...
        <main class="p-4 min-vh-100">
            ...
            <div class="container-fluid">
                ...
                JOIN album ON album_videos.album_id = album.album_id                                   
                                WHERE album_videos.album_videos_id = {$album_id}";
                ...
                ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h2>Update Album Video</h2>

                                        <div class="tab-content mt-3">
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                <!-- <form action="" method="POST"> -->
                                                <form action="Save_Update_album_video.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row">

                                                        <div class="form-group">
                                                            <input type="hidden" name="album_id" class="form-control" value="<?php echo $row['album_videos_id'] ?>" placeholder="">
                                                        </div>
                                                        ...
                                                        <div class="mt-2 col-10">
                                                            <select name="album_name" class="form-select" id="example-select" required>
                                                                ...
                                                                <?php
                                                                  include('include/config.php');
                                                                $sql1 = "SELECT * FROM album"; // if there is anyname same username record be not be inserted
                                                                ...
                                                                if (mysqli_num_rows($result1) > 0) {
                                                                    while ($row1 = mysqli_fetch_assoc($result1)) {
                                                                        ...
                                                                        echo "<option {$selected} value='{$row1['album_id']}'>{$row1['album_name']}</option>";
                                                                    }
                                                                }
                                                                ?>
                                                            </select>
