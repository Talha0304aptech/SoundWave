                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)) {   ?>
                                            <tr>
                                                ...
                                                <td class='id'><?php echo $row['video_id']; ?> </td>
                                                ...
                                                <td class='edit'><a href='Update_video.php?id=<?php echo $row['video_id']; ?>'><i class='mdi mdi-pencil'></i></a></td>

                                                <td class='delete'><a href='Delete_video.php?id=<?php echo $row['video_id']; ?>'><i class='mdi mdi-delete'></i></a></td>
