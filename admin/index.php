...
<body>
  ...
  <div class="col-md-9 col-lg-10 ml-md-auto px-0 ms-md-auto">
    ...
    <div class="jumbotron jumbotron-fluid rounded bg-white border-0 shadow-sm ">
        <div class="container">
      <section class="row">
        ...
        <div class="col-md-6 col-lg-4">
          ...
          $count = "SELECT COUNT(user_id) AS user_id FROM user";


          $result = mysqli_query($db, $count) or die("Query Failed");
       ...
       mb-4" style="border-left: 5px solid orangered;">
                <a href="User_Account.php" class="d-flex align-items-center">
                <h1 class="bi bi-people-fill" style="color: #3D3833;"></h1>&nbsp;&nbsp;
                  <h3 class="ml-2" style="color: #796F6F;">Total User On Website : <span style="color: #3B3A3A;"><?php echo $row['user_id'];?></h3>
                  </span> </a>
              </article> <?php }
                      } ?>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
<?php
        $count = "SELECT COUNT(video_id) AS video_id FROM video";
...
<article class="p-4 rounded shadow- 
       mb-4" style="border-left: 5px solid orangered;">
                <a href="video.php" class="d-flex align-items-center">
                <h1 class="bi bi-camera-video-fill" style="color: #3D3833;"></h1>&nbsp;&nbsp;
                  <h3 class="ml-2" style="color: #796F6F;">Total Video On Website : <span style="color: #3B3A3A;"><?php echo $row1['video_id'];?></h3>
                  </span> </a>
              </article> <?php }
                      } ?>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
<?php
        $count = "SELECT COUNT(music_id) AS music_id FROM music";
...
<article class="p-4 rounded shadow- 
       mb-4" style="border-left: 5px solid orangered;">
                <a href="music.php" class="d-flex align-items-center">
                <h1 class="bi bi-music-note-list" style="color: #3D3833;"></h1>&nbsp;&nbsp;
                  <h3 class="ml-2" style="color: #796F6F;">Total Music On Website : <span style="color: #3B3A3A;"><?php echo $row2['music_id'];?></h3>
                  </span> </a>
              </article> <?php }
                      } ?>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
<?php
        $count = "SELECT COUNT(album_id) AS album_id FROM album";
...
<article class="p-4 rounded shadow- 
       mb-4" style="border-left: 5px solid orangered;">
                <a href="album.php" class="d-flex align-items-center">
                <h1 class="bi bi-file-earmark-plus-fill" style="color: #3D3833;"></h1>&nbsp;&nbsp;
                  <h3 class="ml-2" style="color: #796F6F;">Total Album On Website : <span style="color: #3B3A3A;"><?php echo $row3['album_id'];?></h3>
                  </span> </a>
              </article> <?php }
                      } ?>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
<?php
        $count = "SELECT COUNT(album_videos_id) AS album_videos_id FROM album_videos";
...
<article class="p-4 rounded shadow- 
       mb-4" style="border-left: 5px solid orangered;">
                <a href="album.php" class="d-flex align-items-center">
                <h1 class="bi bi-file-earmark-play-fill" style="color: #3D3833;"></h1>&nbsp;&nbsp;
                  <h3 class="ml-2" style="color: #796F6F;">Total Album Video On Website : <span style="color: #3B3A3A;"><?php echo $row4['album_videos_id'];?></h3>
                  </span> </a>
              </article> <?php }
                      } ?>
        </div>
