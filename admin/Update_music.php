    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0 ms-md-auto">
        ...
        <main class="p-4 min-vh-100">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT *,category.category_name,category.category_id FROM music 
                JOIN category ON music.ctg_id = category.category_id                                   
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content mt-3">
                                            <div class="tab-pane show active" id="basic-form-preview">
                                                ...
                                                <form action="Save_Update_music.php" method="POST" enctype="multipart/form-data">
                                                    <div class="row">

                                                        <div class="form-group">
                                                            <input type="hidden" name="music_id" class="form-control" value="<?php echo $row['music_id'] ?>" placeholder="">
                                                        </div>
                                                        <div class="mt-1 mb-3 col-2">
                                                            <label for="exampleInputEmail1" class="form-label">Music Name : </label>
                                                        </div>
                                                        <div class=" col-10">
                                                            <input type="text" name="music_name" value="<?php echo $row['name'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="text" name="artist_name" value="<?php echo $row['artist'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="text" name="year_name" value="<?php echo $row['year'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="text" name="genre_name" value="<?php echo $row['genre'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        <div class="mt-1 mb-3 col-2">
                                                            <label for="exampleInputEmail1" class="form-label">Image : </label>
                                                        </div>
                                                        <div class=" col-10">
                                                            <input type="file" name="new_music_img" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" >
                                                            <img src="upload/<?php echo $row['filepath'] ?>" height="150px">
                                                            <input type="hidden" name="old_image" value="<?php echo $row['filepath'] ?>">
                                                        </div>
                                                        ...
                                                        <div class=" col-10">
                                                            <input type="text" name="music_trailer" value="<?php echo $row['trailer'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required>
                                                        </div>
                                                        ...
                                                        <div class="col-10">
                                                            <textarea name="music_desc" class="form-control"  rows="5" required>
                                                        ...
                                                        <div class="mt-2 col-10">
                                                            <select name="music_Category" class="form-select" id="example-select" required>
                                                                <option disabled> Select Category</option>

                                                                <?php
                                                                  include('include/config.php');
                                                                $sql1 = "SELECT * FROM category"; // if there is anyname same username record be not be inserted
                                                    ...
                                                    <button type="submit" name="update_add" class="btn btn-primary">UPDATE</button>
                                                </form>
                                            </div> <!-- end preview-->
