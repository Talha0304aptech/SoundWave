                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)) {   ?>
                                            <tr>
                                                ...
                                                <td class='id'><?php echo $row['rating_id']; ?> </td>
                                                ...
                                                <td><?php echo substr($row['review'], 0, 25); ?> </td>
                                                <td><?php echo $row['date']; ?> </td>


                                               

                                                <td class='delete'><a href='Delete_album_review.php?id=<?php echo $row['rating_id']; ?>'><i class='mdi mdi-delete'></i></a></td>
