...
$sql = "UPDATE album_videos SET name='{$video_name}' , artist='{$artist_name}', year='{$year_name}', genre='{$genre_name}', description='{$movie_desc}', filepath='{$file_name}',trailer='{$video_trailer}',album_id={$album_name}
        WHERE album_videos_id={$album_id}";        
