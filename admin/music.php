                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)) {   ?>
                                            <tr>
                                                ...
                                                <td class='id'><?php echo $row['music_id']; ?> </td>
                                                ...
                                                <td class='edit'><a href='Update_music.php?id=<?php echo $row['music_id']; ?>'><i class='mdi mdi-pencil'></i></a></td>

                                                <td class='delete'><a href='Delete_music.php?id=<?php echo $row['music_id']; ?>'><i class='mdi mdi-delete'></i></a></td>
