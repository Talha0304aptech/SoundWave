...
<header class="site-header">
  ...
  <?php
  $album_videos_id = $_GET['id'];
  //  $conn=mysqli_connect("localhost","root","","crud_operations") or die("connection failed");
  include('include/config.php');
  $query = "select * from album_videos where album_videos_id = {$album_videos_id}";
...
<form action="submit_review_album_video.php" method="post">
<!-- <form action="submit_review.php" method="post" id="reviewForm"> -->


  <input type="hidden" value="<?php $album_videos_id = $_GET['id'];   echo $album_videos_id;?>" name="album_videos_id"/>
...
<?php
 $album_videos_id = $_GET['id'];
              ...
              inner join
              album_videos b
              on a.album_videos_id=b.album_videos_id where b.album_videos_id={$album_videos_id}";
              ...
              echo '  <div class="container" data-bg-color="#191919" style="width: 70%; border-radius: 6px;">
                ...
                <blockquote >
                  ...
                  for ($i = 1; $i <= $album_rows['rating']; $i++) {
                    echo ' <input type="radio" id="star5" name="rating" value='. $album_rows['rating'] .'><label for="star5" style="color: #FFD700;"></label>';
                  }
                  echo '  </div><br>
