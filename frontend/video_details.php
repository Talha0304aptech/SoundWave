...
<form action="submit_review_video.php" method="post">
<!-- <form action="submit_review.php" method="post" id="reviewForm"> -->


  <input type="hidden" value="<?php $video_id = $_GET['id'];   echo $video_id;?>" name="video_id"/>
...
<?php
 $video_id = $_GET['id'];
              ...
              inner join
              video b
              on a.video_id=b.video_id where b.video_id={$video_id}";
              ...
              echo '  <div class="container" data-bg-color="#191919" style="width: 70%; border-radius: 6px;">
                ...
                <blockquote >
                  ...
                  for ($i = 1; $i <= $video_rows['rating']; $i++) {
                    echo ' <input type="radio" id="star5" name="rating" value='. $video_rows['rating'] .'><label for="star5" style="color: #FFD700;"></label>';
                  }
                  echo '  </div><br>
