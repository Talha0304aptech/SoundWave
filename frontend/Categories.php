    ...
    <main class="main-content">
      <div class="fullwidth-block gallery">
        <div class="container">
          ...
          <div class="filter-links" style="float: right;"><a href="" class="current">Music's</a>
              <a href="Categories_video.php"  >Video's </a></div>
            ...
            <div class="filterable-items">
              ...
              $query = ('SELECT * FROM music where ctg_id =1');
              ...
              while ($row = mysqli_fetch_assoc($data)) {
                ...
                echo ' <div class="filterable-item ARTIST">
                  ...
                  <a href="music_details.php?id=' . $row['music_id'] . '"
                    ><figure>
              ...
              $query = ('SELECT * FROM talha_database.music where ctg_id =2');
              ...
              while ($row2 = mysqli_fetch_assoc($data2)) {
                ...
                <a href="music_details.php?id=' . $row2['music_id'] . '"
                  ><figure>
              ...
              $query = ('SELECT * FROM talha_database.music where ctg_id =3');
              ...
              while ($row3 = mysqli_fetch_assoc($data3)) {
                ...
                <a href="music_details.php?id=' . $row3['music_id'] . '"
                  ><figure>
              ...
              $query = ('SELECT * FROM talha_database.music where ctg_id =4');
              ...
              while ($row4 = mysqli_fetch_assoc($data4)) {
                ...
                <a href="music_details.php?id=' . $row4['music_id'] . '"
                  ><figure>
